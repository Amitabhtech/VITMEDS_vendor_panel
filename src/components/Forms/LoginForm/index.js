      ...
      <div className="my-5">
        <div className="relative mt-2 rounded-md shadow-sm">
          <input
            ...
            name="price"
            id="price"
            className="block outline-none w-full rounded-md border-0 py-1.5 pl-20  text-gray-900 ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 sm:text-sm sm:leading-6"
            placeholder="Enter mobile number"
          />
          <div className="absolute inset-y-0 left-0 flex items-center px-2 bg-gray-100 rounded-l-md border">
            {/* <select
              id="currency"
              name="currency"
